...
const HomePage = () => {
  return (
    <div className={`${poppins.className} bg-white text-gray-900`}>
      ...
      <div className="container h-[90vh] mx-auto py-[1vh]">
      ...
      <div className="container 2xl: max-w-[80%] mx-auto pt-[10vh] pb-[7vh]">
        <h2
        ...
        <div className="flex justify-between items-center">
          ...
          >
            <div className="h-[5.3vh] w-[6.1vw] flex gap-1 justify-center items-center border hover:text-white hover:bg-app_purple transition-all delay-300">
              <IoFilterOutline />
              Filter
            </div>
            <div className="h-[5.3vh] w-[7.2vw] flex gap-1 justify-center items-center border hover:text-white hover:bg-app_purple transition-all delay-300">
              <IoSearchOutline />
              Search
            </div>
          </div>
